...
void soloAWP() {
    ...
    chassis.turnToPoint(alliance*-45, (a ? -26 : -20), 1000);
    chassis.moveToPoint(alliance*-45, (a ? -26 : -20), 1000);

    chassis.turnToPoint(alliance*-25, -43, 1000, {.forwards=false});
    chassis.moveToPoint(alliance*-25, -43, 1000, {.forwards=false});

    chassis.turnToPoint(alliance*20, (a ? -43 : -52), 1000);
    chassis.moveToPoint(alliance*20, (a ? -43 : -52), 2000, {.maxSpeed=40});
    ...
    chassis.moveToPoint(xcoordinate, (a ? -25 : -20), 1000, {.forwards=false, .maxSpeed=127, .minSpeed=50, .earlyExitRange=14});
    chassis.moveToPoint(xcoordinate, (a ? -25 : -20), 1000, {.forwards=false, .maxSpeed=50, .minSpeed=10});
    ...
    chassis.waitUntilDone();
    delay(200);
    chassis.turnToPoint((a ? 45 : -45), (a ? -20 : -22), 800);
    chassis.moveToPoint((a ? 45 : -45), (a ? -20 : -22), 800);
    chassis.waitUntilDone();
    chassis.turnToPoint((a ? 13 : -10), (a ? -10 : -13), 300, {.forwards=false});
    chassis.moveToPoint((a ? 13 : -10), (a ? -10 : -13), 1000, {.forwards=false});
    chassis.waitUntilDone();
    setIntakeSpeed(0, 0);
}
...
void ringSide(){
    ...
    chassis.moveToPoint(xcoordinate, -28, 1000, {.forwards=false, .maxSpeed=70, .minSpeed=5});
    chassis.waitUntil(17);
    clamp.extend();
    chassis.waitUntilDone();
    delay(100);
    ...
    //ring 1&2
    chassis.turnToPoint((a ? -37 : 40), (a ? -13 : -9), 800);
    delay(200);
    setIntakeSpeed(127, 127);
    chassis.moveToPoint((a ? -37 : 40), (a ? -13 : -9), 800, {.maxSpeed=70, .minSpeed=10});
    chassis.waitUntilDone();
    delay(100);
    chassis.swingToHeading(alliance*-89, a ? DriveSide::LEFT : DriveSide::RIGHT, 800);
    chassis.moveToPoint((a ? -55 : 55), (a ? -13 : -8), 800, {.maxSpeed=70, .minSpeed=10});

    //ring 3
    chassis.turnToPoint(alliance*-25, (a ? -17 : -15), 500, {.forwards = false});
    chassis.moveToPoint(alliance*-25, (a ? -17 : -15), 1000, {.forwards=false, .maxSpeed=90});
    chassis.waitUntilDone();
    delay(100);
    chassis.turnToPoint(alliance*-45, (a ? -26 : -20), 400);
    chassis.moveToPoint(alliance*-45, (a ? -26 : -20), 900);

    chassis.turnToPoint((a ? -54 : 61), (a ? -51: -48), 800, {.maxSpeed=100, .minSpeed=20});
    chassis.waitUntilDone();
    chassis.moveToPoint((a ? -54 : 61), (a ? -51: -48), 1500, {.maxSpeed=100, .minSpeed=20});
    chassis.waitUntilDone();
    stage=0;
    ...
    if (elims) {
        ...
        chassis.moveToPoint(alliance*25, (a ? -50 : -52), 2000, {.maxSpeed=40});
        chassis.waitUntilDone();
    } else {
        chassis.turnToPoint(-18, -18, 1000, {.forwards=false});
        chassis.moveToPoint(-18, -18, 1000, {.forwards=false});
        chassis.waitUntilDone();
        setIntakeSpeed(0, 0);
    }
...
void ringSideRush(){
    bool a = (alliance == 1);
    chassis.setPose(-48, -53.5, 0);

    setIntakeSpeed(0, 127);
    chassis.moveToPoint(-50, -20, 1000, {.maxSpeed=127, .minSpeed=90});
    delay(100);
    sweeper.extend();
    chassis.waitUntilDone();
    setIntakeSpeed(0, 0);
    ...
    chassis.turnToPoint(-50, -8, 1000);
    chassis.moveToPoint(-50, -8, 1000, {.maxSpeed=50});

    chassis.turnToPoint(-48, -18, 1000, {.forwards=false});
    chassis.moveToPoint(-48, -18, 1000, {.forwards=false});
    chassis.turnToPoint(-36, -48, 1000);
    chassis.moveToPoint(-36, -48, 1000);

    chassis.turnToPoint((a ? -50 : 61), (a ? -51: -48), 800, {.maxSpeed=100, .minSpeed=20});
    chassis.waitUntilDone();
    chassis.moveToPoint((a ? -50 : 61), (a ? -51: -48), 1500, {.maxSpeed=100, .minSpeed=20});
    chassis.waitUntilDone();
    stage=0;
    chassis.turnToHeading((a ? 215: 155), 500, {.maxSpeed=80, .minSpeed=30}, false);
    chassis.waitUntilDone();
...
void goalSide(){
    ...
    chassis.moveToPoint(30, -30, 2500, {.forwards=false, .maxSpeed=100});
    chassis.turnToPoint(13, -13, 1000);
    setIntakeSpeed(0, 0);
    chassis.waitUntilDone();
    sweeper.extend();
    delay(100);
    chassis.moveToPoint(13, -13, 1000);
    chassis.waitUntilDone();
    setIntakeSpeed(0, 0);
    chassis.moveToPoint(25, -25, 1000, {.forwards=false});
    chassis.waitUntilDone();
    sweeper.retract();
    delay(100);
